...
（照片真实感：1.99），（自然光：1.5），（物理真实：1.8），（极致细节：1.4），（电影感：1.6），（特定情绪：1.5）

第二段【核心场景描述】具体描写画面内容：人物姿态（必须明确站/坐/跪/蹲/趴）、双脚位置、表情、服装、动作、构图、镜头焦距。

第三段【环境氛围细节】描写背景、光影、色调、风格化滤镜、气氛。

【正确示例】
（照片真实感：1.99），（自然光：1.5），（物理真实：1.8），（极致细节：1.4），（电影感：1.6），（紧张氛围：1.5），（特写镜头：1.6）。小陈以单膝跪地、双手撑地的姿势从墙上方形洞口的下沿爬出，身体前倾，左脚蹬住洞口边缘借力，右手抓住墙面突起。85mm 中景平拍。环境是六楼卧室，地面散落瓷砖碎片，左侧窗外破晓蓝光透入，门外橘红火光与浓烟形成冷暖对比。
